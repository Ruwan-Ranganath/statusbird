defmodule StatusbirdWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StatusbirdWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StatusbirdWeb.Gettext, "errors", msg, opts)
    end
  end
